...
from cassandraoperations.cassandainsert_module import cassandainsert_class
...
def index():
    if request.method == 'POST':
        try:
            ...
            param = [age, sex, TSH, TT4, T3, T4U, FTI, res_val]
            inertdb=cassandainsert_class(param)
            inertdb.cassandainsert_fnc()
